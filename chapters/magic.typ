...
#large-title[== Magical Implements <magical-implements>]
...
#large-title[== Casting a Spell <casting-a-spell>]
...
#large-title[== Learning New Spells <learning-new-spells>]
...
#large-title[== Grimoires <grimoires>]
...
#item-title[=== Expanding Your Grimoire <expanding-your-grimoire>]
...
#item-title[=== Transfer a Spell from another Grimoire to Yours]
...
#item-title[=== Transfer a Spell from a Staff to Your Grimoire]
...
#large-title[== Staves <staves>]

Staves in #emph(title) are bound to their creators.

#large-title[== Creating Spells]

Creating spells takes a long time and a lot of money and energy.

#large-title[== Ley Energy <ley-energy>]
...
- If you roll multiple sixes, instead of becoming exposed to chaos, you roll a
  ...
  #note[
    *Note:* Even if you roll multiple numbers other than six, but you roll multiple
    sixes, you still do not become exposed to chaos. If you roll multiples, but not
    multiple sixes, then you do not become exposed to chaos.
  ]
...
#large-title[== Exposure to Chaos <exposure-to-chaos>]
